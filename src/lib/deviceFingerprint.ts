...
export class DeviceFingerprint {
  ...
  // COMMENTED OUT: Generate browser fingerprint based on available browser features
  ...
  // COMMENTED OUT: Simple font detection using canvas
  ...
  // COMMENTED OUT: Simple hash function for fingerprint
  ...
  async getDeviceId(): Promise<string> {
    ...
    // Generate simple device ID: 'dev_' + timestamp + '_' + random string
    ...
    // COMMENTED OUT: Complex fingerprinting code
  ...
  // COMMENTED OUT: Get device info for debugging (fingerprinting removed)
